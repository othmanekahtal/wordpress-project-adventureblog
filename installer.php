...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'adventureblog_845709299ba62b906975_20210627140120_archive.zip';
	const ARCHIVE_SIZE		 = '39322362';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8457092-27140120';
    const SECONDARY_PACKAGE_HASH = '7100fb7-27140120';
	const VERSION			 = '1.4.1';
